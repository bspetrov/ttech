  ...
  return (
    <React.Fragment>
      <div className="recent-post">
        <h5>Recent Post</h5>
        <img src="/ttech/assets/img/blog/recent-post-bg.jpg" alt="" />
        ...
        <img src="/ttech/assets/img/blog/recent-post-bg-2.jpg" alt="" />
        <div className="single-recent-post">
        ...
        <img src="/ttech/assets/img/blog/recent-post-bg-3.jpg" alt="" />
        <div className="single-recent-post">
