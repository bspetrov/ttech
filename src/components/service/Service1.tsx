          ...
          <div className="row align-items-center position-relative">
            <div className="col-xl-4">
              <div className="section-title">
                ...
                <h2>Услуги, изработки</h2>
              </div>
            </div>
            <div className="col-xl-6">
              <p>
              Изработваме детайли по чертеж, прикачен файл или чрез лично договаряне с изключителна прецизност от следните материали. Доверете ни се за високо качество и внимание към всеки детайл!
              </p>
            </div>
